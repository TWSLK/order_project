...
<meta name="description" content="×¨Çø  - Discuz! Board">
									...
									<tbody>
										<tr>
											...
											<td valign="middle" width="157"><div align="left">
													<a href="thinkshop.cn.htm" target="_blank"><br>
													</a>
												</div>
											</td>
									...
									<tbody>
										<tr>
											...
											<td width="225"><table align="right" border="0"
													...
													<tbody>
														<tr>
															<td width="75"><a href="index.php.htm"><br>
															</a>
															</td>
...
<table style="table-layout: fixed;" align="center" border="0"
	...
	<tbody>
		<tr>
			<td class="nav" align="left" nowrap="nowrap" width="90%"> Register</td>
...
<form method="post" name="register" action="register_deal.jsp">
	...
	<table class="tableborder" align="center" cellpadding="4"
		...
		<tbody>
			<tr>
				<td colspan="2" class="header">Register</td>
			</tr>
			<tr>
				<td class="altbg1" width="21%">Account:</td>
			...
			<tr>
				<td class="altbg1">ConfPassword:</td>
