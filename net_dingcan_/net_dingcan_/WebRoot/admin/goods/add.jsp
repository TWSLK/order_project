...
<body leftmargin="0" rightmargin="0" topmargin="0"
	...
	<form action="goods_save.action" method="post" enctype="multipart/form-data">
		
		<input name="goods.goods_id" value="${goods.goods_id }" type="hidden" />
		<input name="goods.goods_type" value="1" type="hidden" />

		<table class="tableborder" align="center" cellpadding="4"
			cellspacing="1" width="97%">
			<tbody>
				<tr>
					<td colspan="2" class="header">添加菜谱</td>
				</tr>
<tr>
						<td class="altbg1">
							名称
						...
						<td class="altbg2">
							<input name="goods.goods_name" value="${goods.goods_name }" type="text" />
						</td>
					</tr>
					...
					<tr>
						...
						<td class="altbg2">
							<input name="goods.goods_price" value="${goods.goods_price }" type="text" />
						</td>
					</tr>
					<tr>
						<td class="altbg1">
						...
						<td class="altbg2">
							<input name="goods.goods_marketprice" value="${goods.goods_marketprice }" type="text" />
						</td>
					</tr>
