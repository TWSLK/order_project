...
<body leftmargin="0" rightmargin="0" topmargin="0"
	...
	<form action="desk_save.action" method="post" enctype="multipart/form-data">
		
		<input name="desk.id" value="${desk.id }" type="hidden" />

		<table class="tableborder" align="center" cellpadding="4"
			cellspacing="1" width="97%">
			<tbody>
				<tr>
					<td colspan="2" class="header">添加餐桌</td>
				</tr>
<tr>
						<td class="altbg1">
							名称
						...
						<td class="altbg2">
							<input name="desk.name" value="${desk.name }" type="text" />
						</td>
					</tr>
