	      ...
	      <DIV style="MARGIN: 0px auto; WIDTH: 936px">
		      <DIV style="BACKGROUND: url(<%=path %>/images/body_05.jpg) no-repeat; HEIGHT: 155px">
			      <DIV style="TEXT-ALIGN: left; WIDTH: 360px; FLOAT: right; HEIGHT: 200px; _height: 95px;">
				      <form action="<%=path %>/login_deal.jsp" name="ThisForm" method="post">
				      <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
				          ...
				          <TR>
					          <TD style="HEIGHT: 30px">
					              <span style="font-family: 微软雅黑;font-size: 13px;">  &nbsp;Account：</span>
					              <INPUT type=text name=userName style="width: 110px;">
					          </TD>
				          </TR>
				          <TR>
					          <TD style="HEIGHT: 30px">
					              <span style="font-family: 微软雅黑;font-size: 13px;"> Password：</span>
				          ...
				          <TR>
					          <TD style="HEIGHT: 50px">
					              ...
					              <input type="button" name="register_submit"  class="btn_bg" value=" Register " 
											onClick="window.location.href='register.jsp'">
								   <input type="button" name="register_submit"  class="btn_bg" value=" Vistor " 
											onClick="window.location.href='front.jsp'">
