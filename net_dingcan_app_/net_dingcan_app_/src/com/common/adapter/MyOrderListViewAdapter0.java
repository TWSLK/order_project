 ...
 */
public class MyOrderListViewAdapter0 extends BaseAdapter{
	private Context context;
	private LayoutInflater inflater;
	private ArrayList<MyOrderList> orderlist;
	private MyOrderListViewActivity0 activiy;
	public MyOrderListViewAdapter0(Context context,MyOrderListViewActivity0 activiy) {
		this.context = context;
		this.inflater = LayoutInflater.from(context);
		this.activiy = activiy;
	}
	public MyOrderListViewAdapter0(Context context) {
		this.context = context;
		this.inflater = LayoutInflater.from(context);
	}
	@Override
