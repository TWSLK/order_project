...
public class AddDuanziComments2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		myApp = (MyApp) AddDuanziComments2.this.getApplication();
		...
		setContentView(R.layout.add_duanzi_comments2);
	...
	public void addXD(String content) {
		...
		String query ="";
		query+="comment="+"食客"+myApp.getLoginName()+"说"+content+"&";
		query+="luxianid="+0+"&";
		query+="status="+1+"&";
...
//					JSONObject obj = new JSONObject(json);
					if(arrlist!="" && !arrlist.equals("arrlist") && arrlist!=null && !arrlist.equals("[]")){
						...
						if(arrlist.equals("1")){
							Toast.makeText(AddDuanziComments2.this, "恭喜，评论成功", Toast.LENGTH_SHORT).show();;
							AddDuanziComments2.this.finish();
						}else{
							Toast.makeText(AddDuanziComments2.this, "抱歉，评论失败", Toast.LENGTH_SHORT).show();;
						}
					}
			...
			e.printStackTrace();
			result = "网络异常！";
			Toast.makeText(AddDuanziComments2.this, result, Toast.LENGTH_SHORT).show();;
		} catch (IOException e) {
			e.printStackTrace();
			result = "网络异常！";
			Toast.makeText(AddDuanziComments2.this, result, Toast.LENGTH_SHORT).show();;
