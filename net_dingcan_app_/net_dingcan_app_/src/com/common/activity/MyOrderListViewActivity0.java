...
public class MyOrderListViewActivity0 extends Activity implements OnScrollListener {

	private ListView themesListView;
	private MyApp myApp;
	private MyOrderListViewAdapter0 adapter;
    private ArrayList<MyOrderList> orderlist;
	private ImageView imageBack;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.wish_theme_list0);
		myApp = (MyApp) MyOrderListViewActivity0.this.getApplicationContext();
		themesListView = (ListView) findViewById(R.id.themesListView);
//		imageBack = (ImageView) findViewById(R.id.imageBack);
		adapter =  new MyOrderListViewAdapter0(MyOrderListViewActivity0.this);
...
//		themesListView.setSelection(0);
	...
	/*	imageBack.setOnClickListener(new OnClickListener() {
		...
		themesListView.setOnScrollListener(MyOrderListViewActivity0.this);
		...
		themesListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Intent intent = new Intent(MyOrderListViewActivity0.this,DeskList1.class);
				Bundle b =new Bundle();
...
//				
					if(arrlist.equals("1")){
						Toast.makeText(MyOrderListViewActivity0.this, "操作成功", Toast.LENGTH_SHORT).show();;
						loadingWishListData();
					}else{
						Toast.makeText(MyOrderListViewActivity0.this, "操作失败", Toast.LENGTH_SHORT).show();;
					}
			...
			e.printStackTrace();
			result = "网络异常！";
			Toast.makeText(MyOrderListViewActivity0.this, result, Toast.LENGTH_SHORT).show();;
		} catch (IOException e) {
			e.printStackTrace();
			result = "网络异常！";
			Toast.makeText(MyOrderListViewActivity0.this, result, Toast.LENGTH_SHORT).show();;
...
//					JSONObject obj = new JSONObject(json);
					if(arrlist!="" && !arrlist.equals("arrlist") && arrlist!=null&& arrlist!="null" && !arrlist.equals("[]")){
						...
						Toast.makeText(MyOrderListViewActivity0.this, "无订单显示", Toast.LENGTH_SHORT).show();;
					}
				} catch (JSONException e) {
					e.printStackTrace();
				}
